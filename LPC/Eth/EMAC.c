...
// Initializes the EMAC ethernet controller
  ...
  PINSEL3 = (PINSEL3 & ~0x0000000F) | 0x00000005; //MDC shutdown
  ...
  MAC_MCFG = MCFG_CLK_SEL | MCFG_SUPP_PREAM;// mdio div 28 times, preamble	
  ...
  MAC_MAC1 = MAC1_PASS_ALL; //MDC starts ticking
...
////	regv = read_PHY (PHY_REG_IDR1);
////	regv = read_PHY (PHY_REG_IDR2);
